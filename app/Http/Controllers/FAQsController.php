...
class FAQsController extends Controller
{
    ...
    public function update(UpdateFAQsRequest $request, $id)
    {
        ...
        // error checks
        if ($result) {
            return redirect()->route('service.create')->with('success', 'Question and answer updated successfully.');
        } else {
    ...
    public function destroy($id)
    {
        ...
        // error checks
        if ($result) {
            return redirect()->route('service.create')->with('success', 'Question and answer deleted successfully.');
        } else {
            return redirect()->route('service.create')->with('fail', 'Something went wrong, try again later.');
        }
    }
