...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="main_content">
            ...
            <p>These terms and conditions outline the rules and regulations for the use of robex's Website, located at
                obex-co.herokuapp.com/.</p>

            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                robex-co if you do not agree to take all of the terms and conditions stated on this page.</p>
            ...
            <p>We employ the use of cookies. By accessing robex-co, you agreed to use cookies in agreement with the
                robex's Privacy Policy. </p>
            ...
            <p>Unless otherwise stated, robex and/or its licensors own the intellectual property rights for all material
                on robex-co. All intellectual property rights are reserved. You may access this from robex-co for your
                own personal use subjected to restrictions set in these terms and conditions.</p>

            <p>You must not:</p>
            <ul>
                <li>Republish material from robex-co</li>
                <li>Sell, rent or sub-license material from robex-co</li>
                <li>Reproduce, duplicate or copy material from robex-co</li>
                <li>Redistribute content from robex-co</li>
            </ul>
            ...
            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                ...
                presence on the website. Comments do not reflect the views and opinions of robex,its agents and/or
                affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To
                the extent permitted by applicable laws, robex shall not be liable for the Comments or for any
            ...
            <p>robex reserves the right to monitor all Comments and to remove any Comments which can be considered
            ...
            <p>You hereby grant robex a non-exclusive license to use, reproduce, edit and authorize others to use,
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
                ...
                absence of robex; and (d) the link is in the context of general resource information.</p>
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                website, you must inform us by sending an e-mail to robex. Please include your name, your organization
            ...
            <p>No use of robex's logo or other artwork will be allowed for linking absent a trademark license agreement.
            </p>
